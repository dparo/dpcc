...
If you would like to build the compiler yourself from scratch please refer to this \urlref{https://github.com/dparo/dpcc/blob/main/README.md}{README} file
present in the project \urlref{https://github.com/dparo/dpcc}{Github Repo}
