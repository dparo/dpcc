...
DPL is mostly a C-alike compatible language. It borrows some syntax also from Rust/JS especially
in the variable delcarations (usage of the keyword \textbf{let})
Spaces and newlines mostly do not matter, they simply introduce token boundaries.

Comments start with the double forward slash `\emph{//}', and C-style multiline comments are
instead not supported.
