...
For simplicity reasons the current codegen emission implementation requires \textbf{two AST passes}. Whether
the implementation of the code generation could be restructured in order to do the same things
in \textbf{single pass} is subject to discussion, but this has not yet been tested.
