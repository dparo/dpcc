...
\begin{itemize}
    \item Typical tokens, identifiers, comments, stuff
    \item Talk about grammar (C-inspired)
    \item Talk about semantics of the language (can print anything)
    \item Talk about the supported types
    \item Talk about the MAIN function
    \item Code Blocks are always required in control flow statements. WHY?
    \item Talk about precedence table and changes that i did. Why these changes?
    \item Talk about variable shadowing, and scope of variables. Variables cannot be redeclared with the same name in the same scope.
    \item Variables can be declared and initialized inline in the for loop
\end{itemize}
