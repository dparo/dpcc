...
\subsubsection{Custom allocator wrapper used internally}

\subsubsection{Typescript code generation used internally}

\subsubsection{Ast traversal functions used internally}
